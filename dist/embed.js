...
function buildIframeUrl(parameters) {
  var url = parameters.baseUrl || 'https://flat.io/embed';

  // Score id or blank embed
  url += '/' + (parameters.score || 'blank');

  // Build qs parameters
  var urlParameters = _Object$assign({
    jsapi: true
  }, parameters.embedParams);

  var qs = _Object$keys(urlParameters).map(function (k) {
 ...
 */
function postMessage$1(embed, method, parameters) {
...
var embeds = new _WeakMap();
var embedsReady = new _WeakMap();
...
var Embed = function () {
  ...
  function Embed(element) {
    ...
    var onReady = new _Promise(function (resolve) {
  ...
  _createClass(Embed, [{
    ...
    value: function ready() {
      return _Promise.resolve(embedsReady.get(this));
    }
  }, {
    key: 'call',
    value: function call(method) {
      ...
      return new _Promise(function (resolve, reject) {
        return _this2.ready().then(function () {
          ...
          postMessage$1(_this2, method, parameters);
        });
      });
    }
